...
i = numpy.array([[1 + 0j, 0 + 0j], [0 + 0j, 1 + 0j]])
x = numpy.array([[0 + 0j, 1 + 0j], [1 + 0j, 0 + 0j]])
y = numpy.array([[0 + 0j, 0 - 1j], [0 + 1j, 0 + 0j]])
z = numpy.array([[1 + 0j, 0 + 0j], [0 + 0j, -1 + 0j]])
h = numpy.array([[1 / math.sqrt(2) + 0j, 1 / math.sqrt(2) + 0j],
                 [1 / math.sqrt(2) + 0j, -1 / math.sqrt(2) + 0j]])

# Our favorite two-qbit gates.
cnot = numpy.array([[1 + 0j, 0 + 0j, 0 + 0j, 0 + 0j],
                    [0 + 0j, 1 + 0j, 0 + 0j, 0 + 0j],
                    [0 + 0j, 0 + 0j, 0 + 0j, 1 + 0j],
                    [0 + 0j, 0 + 0j, 1 + 0j, 0 + 0j]])
swap = numpy.array([[1 + 0j, 0 + 0j, 0 + 0j, 0 + 0j],
                    [0 + 0j, 0 + 0j, 1 + 0j, 0 + 0j],
                    [0 + 0j, 1 + 0j, 0 + 0j, 0 + 0j],
                    [0 + 0j, 0 + 0j, 0 + 0j, 1 + 0j]])
